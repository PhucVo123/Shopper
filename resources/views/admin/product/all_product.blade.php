      ...
      <table class="table table-striped b-t b-light">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><img src="public/uploads/product/{{$product->product_img}}" width="100px" /></td>
            ...
            <td>
              ...
              <a href="{{URL::to('/delete-product/'.$product->product_id)}}" class="active" ui-toggle-class="" onclick="return confirm('Are you sure?')">
                <i class="fa fa-times text-danger text" ></i>
                <?php Session::put('id', $product->product_id); ?>
              </a>
            </td>
          </tr>
          @endforeach
